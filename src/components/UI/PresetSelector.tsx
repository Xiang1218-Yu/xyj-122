...
import { BookOpen, Sparkles, X, Lightbulb, Check } from 'lucide-react';
...
export function PresetSelector() {
  ...
  const headerExtra = currentPresetId ? (
    <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-500/30 text-emerald-300 mr-1 whitespace-nowrap">
      已加载
    </span>
  ) : undefined;
  ...
  return (
    <>
      ...
      <CollapsibleDraggablePanel
        ...
        zIndex={40}
        width={320}
        contentClassName="p-4 pt-0 max-h-[70vh] overflow-y-auto"
